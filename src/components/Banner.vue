<template>
    ...
    <div class="apresentacao">
      <img src="../assets/imagens-main/images/logo.svg" alt="Logo Projeto"
      class="logo">
    ...
    <img src="../assets/imagens-main/images/foto-banner.png" alt="Foto de uma mulher sorrindo, cozinhando com uma bacia de vidro nas mãos"
    class="foto-banner">
  </header>
</template>
